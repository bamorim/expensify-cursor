              ...
              <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-white/50">
                        Sent: {invitation.createdAt.toLocaleDateString()} • {formatExpiryDate(invitation.expiresAt)}
                      </p>
                    </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    disabled={cancelInvitation.isPending && cancellingInvitation === invitation.id}
                    className="px-3 py-1 bg-red-500/20 text-red-300 rounded text-sm hover:bg-red-500/30 disabled:opacity-50"
                  >
                    {cancelInvitation.isPending && cancellingInvitation === invitation.id ? "Cancelling..." : "Cancel"}
                  </button>
                </div>
              </div>
            </div>
